		...
		<table class="layui-table">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="username" value="admin" class="layui-input" disabled="disabled">
					</td>
					<td>
						<input type="text" name="name" value="hs" class="layui-input" disabled="disabled">
					</td>
					<td>
						<input type="text" name="role" value="超级管理员" class="layui-input" disabled="disabled">
					</td>
					<td><a title="编辑"
